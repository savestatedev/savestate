...
describe('public marketing checkout CTAs', () => {
  ...
  const backupStrategiesCritical = loadHtml('site/blog/ai-backup-strategies-critical.html');
  const securityRisks = loadHtml('site/blog/ai-security-risks-backup-strategy.html');
  ...
  const v070Legacy = loadHtml('site/blog/v0-7-0-migration-wizard.html');
  ...
  it('points the adversarial-attack post CTAs at the live Payment Links', () => {
    expect(hrefForCta(adversarialAttack, 'adversarial-attack-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(adversarialAttack, 'adversarial-attack-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(adversarialAttack, 'adversarial-attack-team-checkout')).toBe(stripe.products.team.payment_link);
    expect(hrefForCta(adversarialAttack, 'adversarial-attack-npm-secondary')).toBe('https://www.npmjs.com/package/@savestate/cli');
    expect(hrefForCta(adversarialAttack, 'adversarial-attack-nav-pro-checkout')).not.toMatch(/npmjs\.com/);
    expect(adversarialAttack).not.toMatch(/class="btn-nav"[^>]*npmjs\.com|npmjs\.com[^>]*class="btn-nav"/);
  });
  ...
  it('points the ram-shortage post CTAs at the live Payment Links', () => {
    expect(hrefForCta(ramShortage, 'ram-shortage-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(ramShortage, 'ram-shortage-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(ramShortage, 'ram-shortage-team-checkout')).toBe(stripe.products.team.payment_link);
  ...
  it('points the state-management-rise post CTAs at the live Payment Links', () => {
    expect(hrefForCta(stateManagementRise, 'state-management-rise-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(stateManagementRise, 'state-management-rise-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(stateManagementRise, 'state-management-rise-team-checkout')).toBe(stripe.products.team.payment_link);
    expect(hrefForCta(stateManagementRise, 'state-management-rise-npm-secondary')).toBe('https://www.npmjs.com/package/@savestate/cli');
    expect(hrefForCta(stateManagementRise, 'state-management-rise-nav-pro-checkout')).not.toMatch(/npmjs\.com/);
    expect(stateManagementRise).not.toMatch(/class="btn-nav"[^>]*npmjs\.com|npmjs\.com[^>]*class="btn-nav"/);
  });

  it('points the ai-evolution post CTAs at the live Payment Links', () => {
    expect(hrefForCta(aiEvolution, 'ai-evolution-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(aiEvolution, 'ai-evolution-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(aiEvolution, 'ai-evolution-team-checkout')).toBe(stripe.products.team.payment_link);
  ...
  it('points the backup-strategies-critical post CTAs at the live Payment Links', () => {
    ...
    expect(hrefForCta(backupStrategiesCritical, 'backup-strategies-critical-team-checkout')).toBe(stripe.products.team.payment_link);
    expect(hrefForCta(backupStrategiesCritical, 'backup-strategies-critical-npm-secondary')).toBe('https://www.npmjs.com/package/@savestate/cli');
    expect(hrefForCta(backupStrategiesCritical, 'backup-strategies-critical-nav-pro-checkout')).not.toMatch(/npmjs\.com/);
    expect(backupStrategiesCritical).not.toMatch(/class="btn-nav"[^>]*npmjs\.com|npmjs\.com[^>]*class="btn-nav"/);
  });

  it('points the security-risks post CTAs at the live Payment Links', () => {
    expect(hrefForCta(securityRisks, 'security-risks-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(securityRisks, 'security-risks-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(securityRisks, 'security-risks-team-checkout')).toBe(stripe.products.team.payment_link);
    expect(hrefForCta(securityRisks, 'security-risks-npm-secondary')).toBe('https://www.npmjs.com/package/@savestate/cli');
    expect(hrefForCta(securityRisks, 'security-risks-nav-pro-checkout')).not.toMatch(/npmjs\.com/);
    expect(securityRisks).not.toMatch(/class="btn-nav"[^>]*npmjs\.com|npmjs\.com[^>]*class="btn-nav"/);
  });

  it('points the agent-security-cicd post CTAs at the live Payment Links', () => {
    expect(hrefForCta(agentSecurityCicd, 'agent-security-cicd-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(agentSecurityCicd, 'agent-security-cicd-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(agentSecurityCicd, 'agent-security-cicd-team-checkout')).toBe(stripe.products.team.payment_link);
    expect(hrefForCta(agentSecurityCicd, 'agent-security-cicd-npm-secondary')).toBe('https://www.npmjs.com/package/@savestate/cli');
    expect(hrefForCta(agentSecurityCicd, 'agent-security-cicd-nav-pro-checkout')).not.toMatch(/npmjs\.com/);
    expect(agentSecurityCicd).not.toMatch(/class="btn-nav"[^>]*npmjs\.com|npmjs\.com[^>]*class="btn-nav"/);
  });

  it('points the google-io post CTAs at the live Payment Links', () => {
    expect(hrefForCta(googleIo, 'google-io-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(googleIo, 'google-io-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(googleIo, 'google-io-team-checkout')).toBe(stripe.products.team.payment_link);
    expect(hrefForCta(googleIo, 'google-io-npm-secondary')).toBe('https://www.npmjs.com/package/@savestate/cli');
    expect(hrefForCta(googleIo, 'google-io-nav-pro-checkout')).not.toMatch(/npmjs\.com/);
    expect(googleIo).not.toMatch(/class="btn-nav"[^>]*npmjs\.com|npmjs\.com[^>]*class="btn-nav"/);
  });

  it('points the reassess-google-io post CTAs at the live Payment Links', () => {
    expect(hrefForCta(reassessGoogleIo, 'reassess-google-io-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(reassessGoogleIo, 'reassess-google-io-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(reassessGoogleIo, 'reassess-google-io-team-checkout')).toBe(stripe.products.team.payment_link);
  ...
  it('points the v070-legacy post CTAs at the live Payment Links', () => {
    expect(hrefForCta(v070Legacy, 'v070-legacy-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(v070Legacy, 'v070-legacy-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(v070Legacy, 'v070-legacy-team-checkout')).toBe(stripe.products.team.payment_link);
    expect(hrefForCta(v070Legacy, 'v070-legacy-npm-secondary')).toBe('https://www.npmjs.com/package/@savestate/cli');
    expect(hrefForCta(v070Legacy, 'v070-legacy-nav-pro-checkout')).not.toMatch(/npmjs\.com/);
    expect(v070Legacy).not.toMatch(/class="btn-nav"[^>]*npmjs\.com|npmjs\.com[^>]*class="btn-nav"/);
  });

  it('points the wizard-architecture post CTAs at the live Payment Links', () => {
    expect(hrefForCta(wizardArchitecture, 'wizard-architecture-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(wizardArchitecture, 'wizard-architecture-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(wizardArchitecture, 'wizard-architecture-team-checkout')).toBe(stripe.products.team.payment_link);
    expect(hrefForCta(wizardArchitecture, 'wizard-architecture-npm-secondary')).toBe('https://www.npmjs.com/package/@savestate/cli');
    expect(hrefForCta(wizardArchitecture, 'wizard-architecture-nav-pro-checkout')).not.toMatch(/npmjs\.com/);
    expect(wizardArchitecture).not.toMatch(/class="btn-nav"[^>]*npmjs\.com|npmjs\.com[^>]*class="btn-nav"/);
  });

  it('points the memory-crisis-2026 post CTAs at the live Payment Links', () => {
    expect(hrefForCta(memoryCrisis2026, 'memory-crisis-2026-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(memoryCrisis2026, 'memory-crisis-2026-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(memoryCrisis2026, 'memory-crisis-2026-team-checkout')).toBe(stripe.products.team.payment_link);
    expect(hrefForCta(memoryCrisis2026, 'memory-crisis-2026-npm-secondary')).toBe('https://www.npmjs.com/package/@savestate/cli');
    expect(hrefForCta(memoryCrisis2026, 'memory-crisis-2026-nav-pro-checkout')).not.toMatch(/npmjs\.com/);
    expect(memoryCrisis2026).not.toMatch(/class="btn-nav"[^>]*npmjs\.com|npmjs\.com[^>]*class="btn-nav"/);
  });

  it('points the amnesia-crisis post CTAs at the live Payment Links', () => {
    expect(hrefForCta(amnesiaCrisis, 'amnesia-crisis-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(amnesiaCrisis, 'amnesia-crisis-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(amnesiaCrisis, 'amnesia-crisis-team-checkout')).toBe(stripe.products.team.payment_link);
  ...
  it('points the federal-guidelines post CTAs at the live Payment Links', () => {
    expect(hrefForCta(federalGuidelines, 'federal-guidelines-nav-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(federalGuidelines, 'federal-guidelines-pro-checkout')).toBe(stripe.products.pro.payment_link);
    expect(hrefForCta(federalGuidelines, 'federal-guidelines-team-checkout')).toBe(stripe.products.team.payment_link);
